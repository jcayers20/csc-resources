...
\begin{document}
	...
	\begin{frame}{Properties of Normal Equations}
		The graph of a \textit{normal distribution} is continuous, bell-shaped, and symmetric.
		
		To illustrate each of these characteristics, here's a picture of the graph of a normally-distributed variable:
